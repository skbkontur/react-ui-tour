    ...
    render() {
        ...
        return (
            <div>
                ...
                {this.state.miniTooltipOpened && (
                    <MiniTooltip
                        target={demo1}
                        positions={['right middle']}
                        onClose={() => this.setState({miniTooltipOpened: false})}
                    >Это обычный минитултип, не зависящий от провайдера
                    </MiniTooltip>
                )}
                ...
                {this.state.miniTourOpened &&
                <TourComponent onClose={() => this.setState({miniTourOpened: false})}>
                    <MiniTooltipStep target={demo1} positions={["bottom left"]}>
                        Это минитур, который должен указывать на изменение в интерфейсе
                        в тот момент, когда новая функция может помочь пользователю
                    </MiniTooltipStep>
                </TourComponent>
                }
            </div>
